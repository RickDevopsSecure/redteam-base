...
Ver `writeups/` para los casos completos: pentest web/DNS en sector salud, CVP de fintech/pagos con revisión de código, y OSINT pasivo en un grupo de telecomunicaciones.
